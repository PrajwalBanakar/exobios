    ...
    <div class="p-4 md:p-6 max-w-3xl mx-auto space-y-5">
        ...
        <div class="px-5 md:px-8 pb-6 relative">
          <div class="relative w-24 h-24 -mt-12 mb-4">
            ...
            <button @click="triggerPhotoUpload"
              ...
              <svg class="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z"/><circle cx="12" cy="13" r="4"/></svg>
            </button>
      ...
      <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 md:p-8">
        ...
        <div class="mt-8 flex items-center gap-3">
          <button @click="saveProfile" class="flex items-center gap-2 px-6 py-2.5 bg-blue-600 hover:bg-blue-700 text-white text-sm font-semibold rounded-xl transition">
