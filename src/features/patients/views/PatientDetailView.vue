    ...
    <div v-else class="p-4 md:p-6 space-y-5">
        ...
        <div class="flex items-start gap-4 flex-wrap">
          ...
          <div class="flex gap-2 flex-shrink-0">
            <button
              ...
              class="flex items-center gap-1.5 px-3 py-2 bg-blue-600 hover:bg-blue-700 text-white text-xs font-semibold rounded-lg transition">
            ...
            <button
              ...
              class="flex items-center gap-1.5 px-3 py-2 border border-gray-200 text-gray-600 hover:bg-gray-50 text-xs font-semibold rounded-lg transition">
      ...
      <div class="bg-white rounded-xl border border-gray-100 shadow-sm">
        ...
        <div v-if="!(patient.assessmentHistory || []).length" class="py-12 text-center">
          ...
          <p class="text-sm text-gray-400">No assessments yet.</p>
          <button
            @click="router.push(`/assessment/new?patientId=${patient.id}`)"
            ...
            <div class="flex items-start gap-4">
              ...
              <div class="flex-1 min-w-0">
                ...
                <div v-if="a.vitals" class="flex flex-wrap gap-3 mt-2">
                  <span v-if="a.vitals.bpSystolic" class="text-[10px] text-gray-500">
                    BP {{ a.vitals.bpSystolic }}/{{ a.vitals.bpDiastolic }}
                  </span>
                  <span v-if="a.vitals.heartRate" class="text-[10px] text-gray-500">
                    HR {{ a.vitals.heartRate }}
                  </span>
                  <span v-if="a.vitals.spo2" class="text-[10px] text-gray-500">
                    SpO₂ {{ a.vitals.spo2 }}%
                  </span>
                  <span v-if="a.vitals.temperature" class="text-[10px] text-gray-500">
                    Temp {{ a.vitals.temperature }}°F
                  </span>
                  <span v-if="a.vitals.rbs" class="text-[10px] text-gray-500">
